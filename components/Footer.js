      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
          <div className="col-span-2 md:col-span-1">
            ...
            <a
              href="https://www.instagram.com/postta.in"
              target="_blank"
          ...
          <div>
            ...
            <ul className="space-y-2 text-xs sm:text-sm">
              ...
              <li>
                <a href="https://wa.me/919335748094" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 hover:text-green-400 transition-colors">
